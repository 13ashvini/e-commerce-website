...
const CategoryProductCards = ({
  ...
  return (
    <div className="w-full   hover:shadow-lg hover:rounded-lg h-full p-3 group flex flex-col gap-5 hover:bg-white">
      ...
      <div className=" flex  bg-white w-full px-10 pt-5 pb-0 gap-3 transition transform invisible translate-y-0 ease-out  group-hover:visible group-hover:translate-y-5">
